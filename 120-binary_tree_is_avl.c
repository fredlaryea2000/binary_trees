...
/**
 * is_avl_helper - Finds out if a binary tree is a valid AVL tree.
 * @tree: A reference to the root node of the tree to check.
...
/**
 * binary_tree_is_avl - Finds out if a binary tree is a valid AVL tree.
 * @tree: A reference to the root node of the tree to check.
 *
 * Return: 1 if tree is a valid AVL tree, and otherwise 0
 */
int binary_tree_is_avl(const binary_tree_t *tree)
{
	if (tree == NULL)
