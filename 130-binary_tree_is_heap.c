...
/**
 * check_max - goes through a binary tree cheking ropt as maximum value
 * @tree: reference to the root
 * Return: 1 if all nodes are maximum, 0 in other cases
 **/
...
/**
 * binary_tree_is_heap - Finds out if a binary tree is heap
