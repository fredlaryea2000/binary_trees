...
/**
 * successor - get the next successor i mean the minimum node in the right subtree
 * @node: tree to check
 ...
 *@root: node to delete
 *Return: 0 if it has no children, otherwise, other value
 */
...
/**
 * bst_remove - delete a node from a BST tree
...
/**
 * avl_remove - delete a node from a AVL tree
 * @root: root of the tree
